...
public class PlayContainerLeft extends PanelContainer{
	...
	public PlayContainerLeft(DataOutputStream toServer, DataInputStream fromServer, ObjectInputStream cardFromServer) {
	...
	public void initializeTopPanel() {
		dealerTitle = new JLabel("Player Two");
